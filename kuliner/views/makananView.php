...
<div class="container mt-5">
    <div class="card-header">
        <h5 class="float-start mt-2 fw-bold">Daftar makanan Tradisional</h5><br>
        <div class="float-end mt-2">
            <a href="?page=makananAdd&id" class="btn btn-sm btn-success">Tambah Data</a>
        </div>
    </div>

    <table id="makananTable" class="table table-striped table-bordered mt-3">
        <thead>
            <tr>
                <th>No.</th>
                <th>Nama makanan</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        if ($val['gambar_makanan']) {
                            ...
                            // Mengonversi gambar biner menjadi base64
                            $gambar_base64 = base64_encode($gambar_makanan);
                            $gambar_src = 'data:' . $mime_type . ';base64,' ;

                            // Menampilkan gambar menggunakan base64
                            echo '<img src=" ' . $gambar_src . $gambar_base64 .' " alt=" ' . $val['nama_makanan'] . '" class="img-thumbnail" style="width: 100px; height: 100px;">';
                        } else {
                    ...
                    <td>
                        <div>
                            <a href="?page=makananUpdate&id=<?= $val['id_makanan']; ?>" class="btn btn-warning btn-sm mx-2">Update</a>
                            <a href="?page=makananDelete&id=<?= $val['id_makanan']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?');">Hapus</a>
                        </div>
                    </td>
                    </td>
                </tr>
